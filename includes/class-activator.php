...
class Hamnaghsheh_Activator
{
    ...
    public static function activate()
    {
        ...
        if ($installed_db_version !== $current_db_version) {
            ...
            if ($wpdb->get_var("SHOW TABLES LIKE '{$order_messages_table}'") != $order_messages_table) {
            ...
            if ($wpdb->get_var("SHOW TABLES LIKE '{$order_activity_table}'") != $order_activity_table) {
